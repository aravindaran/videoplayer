...
class videojsXBlock(XBlock):
    ...
    def student_view(self, context=None):
        ...
        context = {
            ...
            'url': self.runtime.local_resource_url(
                self, 'public/videos/overpass-clip.mp4'),
            'valiant360_css': self.runtime.local_resource_url(
                self, 'public/css/valiant360.css'),
            'jquery_valiant360_js': self.runtime.local_resource_url(
                self, 'public/js/jquery.valiant360.js'),
            'three_min_js': self.runtime.local_resource_url(
                self, 'public/js/three.min.js'),
    ...
    def workbench_scenarios():
        ...
        return [("VideoJs", "<vertical_demo><videojs/></vertical_demo>")]
